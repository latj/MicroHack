# Setting Variables
$pathToRepo = "https://raw.githubusercontent.com/microsoft/MicroHack/refs/heads/main/03-Azure/01-03-Infrastructure/06_Migration_Secure_AI_Ready/resources/demopage"
